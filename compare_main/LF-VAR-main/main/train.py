...
def build_everything(args: arg_util.Args):
    ...
    if not args.local_debug:
        ...
        num_classes, dataset_train, dataset_val = build_dataset(
            args.data_path, final_reso=args.data_load_reso, hflip=args.hflip, mid_reso=args.mid_reso, args=args
        )
    ...
    if dist.is_local_master():
        if not os.path.exists(vae_ckpt):
            ...
            vae_url = f'{os.environ.get("HF_ENDPOINT")}/FoundationVision/var/resolve/main/{vae_ckpt}'
            os.system(f'wget {vae_url}')
    dist.barrier()
